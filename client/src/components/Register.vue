<template>
  <div>
    ...
    <form>
      ...
      <select for="gymFreq" id="gymFreq" v-model="gymFreq">
      ...
      <select for="yoe" id="yoe" v-model="yoe">
      ...
      <select for="tot" id="tot" v-model="tot">
      ...
      <select for="gymLoc" id="gymLoc" v-model="gymLoc">
